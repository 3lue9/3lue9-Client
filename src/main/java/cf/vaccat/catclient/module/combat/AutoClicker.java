package cf.vaccat.catclient.module.combat;
 ...
 CatClient.instance.settingsManager.rSetting(new Setting("MinCPS", this, 8, 1, 20, false));
 CatClient.instance.settingsManager.rSetting(new Setting("MaxCPS", this, 12, 1, 20, false));
 }
 ...
 min = CatClient.instance.settingsManager.getSettingByName(this, "MinCPS").getValDouble();
 max = CatClient.instance.settingsManager.getSettingByName(this, "MaxCPS").getValDouble();
