package cf.vaccat.catclient.module.utils.menu;


import cf.vaccat.catclient.module.utils.menu.tools.ChangeUser;
...
public class TutorialMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        //Change User
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, i + 72 - 12, 98, 20, "Ban Bypass"));

        //Author
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, i + 72 - 12, 98, 20, "Author"));
        ...
        if (button.id == 0) {
            ...
            try {
                ...
                if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                    desktop.browse(new URI("https://www.youtube.com/channel/UCeKRSJv9f97FMU0Owdei8pA"));
                }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        //drawLogo.drawString(5, "3lue9 Client", this.width / 10 - this.fontRenderer.getStringWidth("3lue9 Client") / 2,
